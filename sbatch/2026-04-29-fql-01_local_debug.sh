...
scripts=(
  "MUJOCO_GL=egl python main.py --env_name=cube-single-play-singletask-v0 --agent.alpha=300 --agent.discount=0.999 --agent.n_step=25 --seed=0 --run_group=2026-04-29-fql-01_debug"
)
