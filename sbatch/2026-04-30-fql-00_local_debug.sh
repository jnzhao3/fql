...
scripts=(
  "MUJOCO_GL=egl python main.py --env_name=antmaze-medium-navigate-singletask-v0 --agent.alpha=300 --agent.discount=0.999 --agent.n_step=25 --seed=0 --run_group=2026-04-30-fql-00_debug"
)
